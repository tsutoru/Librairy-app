...
public class ArrivalMovementController {
    ...
    @PostMapping
    public ResponseEntity<ArrivalMovement> recordArrival(
    ...
    public ResponseEntity<List<ArrivalMovement>> getByBookId(
            @PathVariable String bookId) {
        return ResponseEntity.ok(arrivalMovementService.getByBookId(bookId));
    }

    @GetMapping("/supplier/{supplier}")
    public ResponseEntity<List<ArrivalMovement>> getBySupplier(

...
public class ReservationCancelledMovementService {
    ...
    public ReservationCancelledMovement cancelReservation(String reservationId,
                                                          String customerId) {
        validateUUID(reservationId);
        validateUUID(customerId);

        ReservationMovement originalReservation = reservationMovementRepository
                .findById(reservationId)
                .orElseThrow(() -> new NotFoundException(
                        "ReservationMovement not found: " + reservationId));
        ...
        originalReservation.getBookCopies().forEach(copy -> {
    ...
    public ReservationCancelledMovement getById(String id) {
        ...
        return cancelledMovementRepository
                .findById(id)
                .orElseThrow(() -> new NotFoundException(
                        "ReservationCancelledMovement not found: " + id));
    }

...
public class SaleMovementController {
  ...
  @PostMapping
  public ResponseEntity<SaleMovement> recordSale(@RequestBody Map<String, Object> body) {
  ...
  public ResponseEntity<List<SaleMovement>> getByBookId(@PathVariable String bookId) {
    return ResponseEntity.ok(saleMovementService.getByBookId(bookId));
  }

  @GetMapping("/customer/{customerId}")
  public ResponseEntity<List<SaleMovement>> getByCustomerId(@PathVariable String customerId) {
